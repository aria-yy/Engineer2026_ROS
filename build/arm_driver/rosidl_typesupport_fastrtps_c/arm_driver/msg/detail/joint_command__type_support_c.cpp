...
#include "arm_driver/msg/detail/joint_command__rosidl_typesupport_fastrtps_c.h"
...
#include "arm_driver/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _JointCommand__ros_msg_type = arm_driver__msg__JointCommand;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_driver
size_t get_serialized_size_arm_driver__msg__JointCommand(
  const void * untyped_ros_message,
...
static uint32_t _JointCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arm_driver__msg__JointCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_driver
size_t max_serialized_size_arm_driver__msg__JointCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_driver__msg__JointCommand;
    is_plain =
      (
...
static size_t _JointCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arm_driver__msg__JointCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_driver, msg, JointCommand)() {
